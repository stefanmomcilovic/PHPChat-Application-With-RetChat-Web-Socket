...
<head>
    <title>Private - PHPChat application using WebSockets</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-5" style="background-color: #f1f1f1; height: 100vh; border-right:1px solid #ccc;">
                ...
                ?>
                    ...
                    <div class="mt-3 mb-3 text-center">
                        ...
                        <a href="chatroom.php" class="btn btn-primary">Go Back To Group Chat</a>
                        <input type="button" class="btn btn-danger mt-2 mb-2" id="logout" name="logout" value="Logout" />
                    </div>
                <?php
                }
            ...
            <div class="col-lg-9 col-md-8 col-sm-7">
                <br />
                <h1 class="text-center">Private - PHPChat application using WebSockets</h1>
                <hr />
                <br />
				...
				<div class="card-header">
					<div class="row">
						...
						<div class="col col-sm-6 text-end">
							...
							<button type="button" id="close_chat_area" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
						</div>
					</div>
				</div>
